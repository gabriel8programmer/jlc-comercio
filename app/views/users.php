...
require_once("modal_new_user.php");
...
<main class="container-fluid">
    ...
    <section class="row px-4 my-3 justify-content-between">
        <div class="col-2">
            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modal_new_user">
                Novo Cadastro
            </button>
        </div>
        <div class="col-4">
            <form action="#" method="get">
                <label for="search-user" class="form-label">Buscar</label>
                <input type="search" id="search-user" class="form-control-inline">
            </form>
        </div>
    </section>

    <section class="row px-4 my-3">
        <div class="col-3">
            <p>
                Mostrar
                <select class="p-2">
